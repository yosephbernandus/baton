...
type ToolRestriction struct {
	...
	Format string `yaml:"format"` // "comma-separated" or "repeat"
}
...
type PhaseMachineConfig struct {
	...
	LibrarianEnabled        *bool          `yaml:"librarian_enabled,omitempty"`
	PhaseBudgets            map[string]int `yaml:"phase_budgets,omitempty"`
}
